...
const Weft = (props) => {
    ...
    const RederWeft = () => {
        ...
        const weft = tartan === null || tartan === void 0 ? void 0 : tartan.fullSet.map((thread, idx) => {
            var _a;
            const rect = jsxRuntime.jsx("rect", { fill: '#' + ((_a = thread.colour) === null || _a === void 0 ? void 0 : _a.hex), width: "100%", height: thread.noOfThreads * tartan.scaledStrokeLength, x: "0", y: y }, 'weft-' + idx);
            y += thread.noOfThreads * tartan.scaledStrokeLength;
            return rect;
        });
        return jsxRuntime.jsx(jsxRuntime.Fragment, { children: weft });
    };
    return (jsxRuntime.jsx("g", { id: "weft", children: jsxRuntime.jsx(RederWeft, {}) }));
};
...
const Warp = (props) => {
    ...
    const RenderWarp = () => {
        ...
        const warp = tartan === null || tartan === void 0 ? void 0 : tartan.fullSet.map((thread, idx) => {
            var _a;
            const rect = jsxRuntime.jsx("rect", { fill: '#' + ((_a = thread.colour) === null || _a === void 0 ? void 0 : _a.hex), height: "100%", width: thread.noOfThreads * tartan.scaledStrokeLength, x: x, y: "0" }, 'warp-' + idx);
            x += thread.noOfThreads * tartan.scaledStrokeLength;
            return rect;
        });
        return jsxRuntime.jsx(jsxRuntime.Fragment, { children: warp });
    };
    return (jsxRuntime.jsx("g", { id: "warp", mask: "url(#threadHatchingMask)", children: jsxRuntime.jsx(RenderWarp, {}) }));
};

const ThreadHatching = (props) => {
    const { tartan } = props;
    const x = (tartan === null ? 2 : tartan.scaledStrokeLength);
    return (jsxRuntime.jsxs("pattern", { "data-testid": 'pattern', id: "threadHatching", x: "0", y: "0", patternUnits: "userSpaceOnUse", width: x * 2, height: x * 2, children: [jsxRuntime.jsx("rect", { x: "0", y: -x / 2, height: x, width: x / 2, fill: "white" }), jsxRuntime.jsx("rect", { x: "0", y: x * 1.5, height: x, width: x / 2, fill: "white" }), jsxRuntime.jsx("rect", { x: x / 2, y: "0", height: x, width: x / 2, fill: "white" }), jsxRuntime.jsx("rect", { x: x, y: x / 2, height: x, width: x / 2, fill: "white" }), jsxRuntime.jsx("rect", { x: x * 1.5, y: x, height: x, width: x / 2, fill: "white" })] }));
};
...
const TartanSVG = (props) => {
    const [tartanEntity, setTartanEntity] = react.useState();
    ...
    const filter = ({ useBlur, blurValue }) => {
        if (useBlur) {
            return (jsxRuntime.jsx("filter", { "data-testid": 'blurFilter', id: "blur", children: jsxRuntime.jsx("feGaussianBlur", { stdDeviation: blurValue, in: "SourceGraphic", result: "BLUR", edgeMode: 'wrap' }) }));
        }
        return null;
    };
    ...
    if (tartanEntity !== undefined) {
        return (jsxRuntime.jsxs("svg", { "data-testid": 'tartanImage', id: id, height: tartanEntity === null || tartanEntity === void 0 ? void 0 : tartanEntity.imageSize, width: tartanEntity === null || tartanEntity === void 0 ? void 0 : tartanEntity.imageSize, style: style, xmlns: "http://www.w3.org/2000/svg", children: [filter(tartanEntity), jsxRuntime.jsxs("defs", { children: [jsxRuntime.jsx("mask", { id: "threadHatchingMask", x: "0", y: "0", width: "1", height: "1", children: jsxRuntime.jsx("rect", { x: "0", y: "0", width: "100%", height: "100%", fill: "url(#threadHatching)" }) }), jsxRuntime.jsx(ThreadHatching, { tartan: tartanEntity }), jsxRuntime.jsxs("pattern", { "data-testid": 'testSett', id: "sett", x: setX, y: setY, patternUnits: "userSpaceOnUse", width: tartanEntity !== null ? (tartanEntity === null || tartanEntity === void 0 ? void 0 : tartanEntity.getSetSize()) * (tartanEntity === null || tartanEntity === void 0 ? void 0 : tartanEntity.scaleFactor) : 0, height: tartanEntity !== null ? (tartanEntity === null || tartanEntity === void 0 ? void 0 : tartanEntity.getSetSize()) * (tartanEntity === null || tartanEntity === void 0 ? void 0 : tartanEntity.scaleFactor) : 0, children: [jsxRuntime.jsx(Weft, { tartan: tartanEntity }), jsxRuntime.jsx(Warp, { tartan: tartanEntity })] })] }), jsxRuntime.jsx("rect", { "data-testid": 'tartanRect', x: "0", y: "0", height: "100%", width: "100%", fill: "url(#sett)", filter: tartanEntity.useBlur ? 'url(#blur)' : '' })] }));
    }
    else {
        return null;
    }
